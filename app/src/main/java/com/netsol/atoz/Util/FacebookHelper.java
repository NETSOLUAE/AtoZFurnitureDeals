...
//                mListener.onFbSignInSuccess();
    ...
    private FacebookUser parseResponse(JSONObject object) throws JSONException {
        ...
        if (object.has("birthday")) user.user_birthday = object.getString("birthday");
    ...
    public void performSignIn(Activity activity) {
        ...
        LoginManager.getInstance().logInWithReadPermissions(activity, Arrays.asList("public_profile", "user_friends", "email", "user_birthday"));
    }
    ...
    public void performSignIn(Fragment fragment) {
        LoginManager.getInstance().logInWithReadPermissions(fragment, Arrays.asList("public_profile", "user_friends", "email", "user_birthday"));
    }

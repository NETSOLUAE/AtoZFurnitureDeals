...
//    private Paint mBadgePaint1;
    ...
    public BadgeDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen.dimen_8s);
...
//        mBadgePaint1.setStyle(Paint.Style.FILL);
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if(mCount.length() <= 2){
            // Draw badge circle.
//            canvas.drawCircle(centerX, centerY, (int)(radius + 5.5), mBadgePaint1); - For border around circle
            canvas.drawCircle(centerX, centerY, (int)(radius + 3.5), mBadgePaint);
        }
        else{
//            canvas.drawCircle(centerX, centerY, (int)(radius + 6.5), mBadgePaint1); - For border around circle
